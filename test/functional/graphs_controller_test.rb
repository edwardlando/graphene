...
class GraphsControllerTest < ActionController::TestCase
  ...
  test "should create graph" do
    assert_difference('Graph.count') do
      post :create, graph: { category: @graph.category, excel_url: @graph.excel_url, graph_type: @graph.graph_type, permalink: @graph.permalink, visualization_name: @graph.visualization_name }
    end
  ...
  test "should update graph" do
    put :update, id: @graph, graph: { category: @graph.category, excel_url: @graph.excel_url, graph_type: @graph.graph_type, permalink: @graph.permalink, visualization_name: @graph.visualization_name }
    assert_redirected_to graph_path(assigns(:graph))
  end
